 ...
 * <ul>
 * <li> `browser:uncompressed` - build uncomprssed browser bundle (`schoolcore-*.js`)
 * <li> `browser:compressed` - build compressed browser bundle (`schoolcore-*.min.js`)
...
function startGulp(name, opts) {
  ...
  var fullname = name ? 'schoolcore-' + name : 'schoolcore';
  var files = ['lib/**/*.js'];
  var tests = ['test/**/*.js'];
  var alljs = files.concat(tests);

  var buildPath = './node_modules/schoolcore-build/';
  ...
  if (browser) {
    ...
    if (name !== 'lib') {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:' + fullname + ' --external schoolcore-lib -o ' + fullname + '.js';
    } else {
      browserifyCommand = buildBinPath + 'browserify --require ./index.js:schoolcore-lib -o schoolcore-lib.js';
    }
